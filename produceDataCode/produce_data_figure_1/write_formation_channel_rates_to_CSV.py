#############################
#  This file uses the hdf5 files to calculate the intrinisc or detectable formation yields  per formation channel of BHNS/BNS/BBH mergers
#  It writes the summary statistics (rates) to a summary csv file 
#  It calculates it for the 5 formation channels as discussed in BHNS paper :) 
# 
#
##################
