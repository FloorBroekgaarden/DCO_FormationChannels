...
def createEmptyCSVplaceholder(DCOtype='BBH', nBPSmodels=15):
    ...
    writePath = '/Users/floorbroekgaarden/Projects/GitHub/DCO_FormationChannels/dataFiles/data_Fig_1/Formation_yields_'  + stringgg + '_'  + DCOname + '.csv' 

    nModels=26
    BPSnameslist = list(string.ascii_uppercase)[0:nModels]
    NAMES = []
    stringgg =  'AllDCOsimulation_formation_channels'
    headerDict_Z  = { 5:'channel VI observed ',     6:'channel VII observed ',    7:'All observed ',     0:'channel V observed ', 1:'channel I observed ', 2:'channel II observed ', 3:'channel III observed ', 4:'channel IV observed '}    
    ...
    for ind_m, m_ in enumerate(BPSnameslist):
        for ind_c, c_ in enumerate(enumerate_list):
            str_ = m_ + ' ' + headerDict_Z[enumerate_list]+ '  [Msun^{-1}]'
            NAMES.append(str_)
