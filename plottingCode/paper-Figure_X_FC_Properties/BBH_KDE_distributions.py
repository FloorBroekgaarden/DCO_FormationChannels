...
# # just one model 
# for ind_BPS, BPSmodel in enumerate([BPSnameslist[1]]):
    ...
    # Most massive compact object mass 
    print('at mass_1_LVK')
    if DCOtype=='BBH':
        bw=0.7
    ...
    plt.savefig('./singlemodel/super_FC_split_panel_%s_%s.pdf'%(DCOtype, BPSmodel), transparent=False, bbox_inches="tight",  format='pdf')
    plt.savefig('./singlemodel/super_FC_split_panel_%s_%s.png'%(DCOtype, BPSmodel), transparent=False, bbox_inches="tight", dpi=600, format='png')
